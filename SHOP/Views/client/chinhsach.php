...
<body>
	<div id="top">
		...
		<div id="main">
			...
			<p>• Nếu linh kiện thay thế không có sẵn, cần phải đặt hàng thì Laptop Tuấn Minh sẽ giải quyết trong thời gian tối đa 01 tuần (không kể ngày Chủ nhật và ngày nghỉ lễ). Nếu quá thời gian 01 tuần mà chưa có linh kiện thay thế, Laptop Tuấn Minh sẽ tiến hành đổi sang máy tương tự khác cho Quý khách hàng.
			</p>
			<p>• Nếu Quý khách hàng không đồng ý đổi sang máy tương tự khác, Laptop Tuấn Minh sẽ nhập một chiếc máy khác cùng model và cấu hình như máy khách đã mua để đổi trong thời hạn tối đa là 01 tháng.
			</p>
			...
			<p>6. KHÔNG bảo hành máy đối với trường hợp mất toàn bộ tem mặt trước hoặc mặt sau, nhưng vẫn giữ bảo hành đối với các phần linh kiện được nâng cấp - thay thế, nếu linh kiện đó còn tem của Laptop Tuấn Minh và của nhà cung cấp.
			</p>

			<p>6. KHÔNG bảo hành máy đối với trường hợp mất toàn bộ tem mặt trước hoặc mặt sau, nhưng vẫn giữ bảo hành đối với các phần linh kiện được nâng cấp - thay thế, nếu linh kiện đó còn tem của Laptop Tuấn Minh và của nhà cung cấp.</p>
			...
			<p>• Kể từ ngày thứ 16 trở đi, Laptop Tuấn Minh sẽ căn cứ theo giá nhập sản phẩm tại thời điểm đó để đưa ra giá thu mua.</p>
			...
			<p>Bảo hành tại các TTBH của hãng hoặc Laptop Tuấn Minh nhận gửi bảo hành máy tại hãng cho khách hàng khi sản phẩm đáp ứng đủ điều kiện bảo hành của hãng: Sản phẩm phải còn nguyên tem bảo hành, không cấn móp, rơi vỡ, không có nước hoặc côn trùng xâm nhập vào, màn hình không vỡ, không chảy mực, không bị chập cháy. 
			</p>
			...
			<p>Địa chỉ: 142 Lương Thế Vinh - Thanh Xuân - HN</p>

			<p>Hotline: 096.690.0220 - 096.801.8880</p>
		</div>
	</body>
	<footer>
		<ul>
