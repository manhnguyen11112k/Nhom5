...
<body>
	...
	$sql = "select taikhoan from dangnhap";
		...
		<div id="top-left">
			<ul>
				...
				<li><a style="border-right: none;" href="">Kết nối </li>
					...
					<?php
					//isset($_SESSION['test'])==$rs["taikhoan"])
					if ("ndmanh"==$rs["taikhoan"]) {?>
						<li>
							<a href="#">
								<?php echo $rs["taikhoan"] ?></a>
							</li>
							<li>
								<a href="">Đăng xuất</a>
							</li>
						...
						<div class="card">
						<br>
						<img style="width:210px; height:160px; "src="../../image/tt5_lt1.jpg" alt="">
						<br>
						<a href="ttchitiet.php"><p>Laptop MSI Modern 14 B5M 064VN</p></a>
						<br>
						<h5>2.499.000₫</h5>
						</div>
						</li>
